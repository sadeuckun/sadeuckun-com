...
const roleSets = {
  ...
  tr: [
    'Yazılım Geliştirici',
    'CRM Sistemleri Geliştiricisi',
    'Yönetim Paneli Geliştiricisi',
    'Otomasyon Odaklı Geliştirici',
    'Node.js Geliştiricisi',
    'FastAPI Geliştiricisi',
    'Next.js Geliştiricisi',
    'Go Geliştiricisi',
    'React Native Geliştiricisi',
    'Sistem Odaklı Geliştirici',
    'AI Destekli Ürün Geliştiricisi',
    'Self-Hosted Sistem Kurucusu',
    'Altyapı Geliştiricisi',
    'Erişilebilirlik Odaklı Geliştirici',
    'Süreç Optimize Edicisi',
  ],
};
